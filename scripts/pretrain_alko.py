...
def main():
    parser = argparse.ArgumentParser(description="Train Alko model")
    parser.add_argument("--model-name", default="alko_big", help="Model name for output")
